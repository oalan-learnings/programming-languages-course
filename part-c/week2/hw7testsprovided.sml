...
print "expected LineSegment(1.00000999,1.0,1.0,2.0)";
preprocess_prog (Intersect(LineSegment(~3.7,1.5,~3.7,1.5),LineSegment(~3.7,1.5,~3.7,1.5)));
print "expected Intersect(Point(~3.7,1.5),Point(~3.7,1.5))";
preprocess_prog (Let ("x",LineSegment(~3.7,1.5,~3.7,1.5),LineSegment(~3.7,1.5,~3.7,1.5)));
print "expected to preprocess to Let (x,Point(~3.7,1.5),Point(~3.7,1.5))";
preprocess_prog (Shift(5.5,~1.2,LineSegment(~3.7,1.5,~3.7,1.5)));
print "expected to preprocess to Shift(5.5,~1.2,Point(~3.7,1.5))";
preprocess_prog (Intersect(LineSegment(1.0,1.0,0.0,0.0),LineSegment(1.0,1.0,0.0,0.0)));
print "expected to preprocess to Intersect(LineSegment(0.0,0.0,1.0,1.0),LineSegment(0.0,0.0,1.0,1.0))";
preprocess_prog (Let ("y",LineSegment(1.0,1.0,0.0,0.0),LineSegment(1.0,1.0,0.0,0.0)));
print "expected to preprocess to Let (y,LineSegment(0.0,0.0,1.0,1.0),LineSegment(0.0,0.0,1.0,1.0))";
preprocess_prog (Shift(1.0,1.0,LineSegment(1.0,1.0,0.0,0.0)));
print "expected to preprocess to Shift(1.0,1.0,LineSegment(0.0,0.0,1.0,1.0))";
